...
namespace BitcoinWalletWatcher.Utilities
{
    ...
    {
        Task PostJsonAsync(string url, string body, IDictionary<string, string> headers = null);
        Task<string> GetJsonAsync(string url, IDictionary<string, string> headers = null);
    }
